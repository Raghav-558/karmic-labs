...
const Values = () => {
  return (
    <div id='services' className='max-md:py-[60px] overflow-hidden'>
        ...
        <div className='flex pt-[77px] max-lg:pt-16 max-md:pt-10 gap-y-10 flex-wrap max-lg:justify-center'>
          {VALUES_LIST.map((obj, i) => (
            ...
            >
              ...
              <div className='p-5 max-sm:p-4 relative group transition-all duration-300 border border-transparent hover:border-white hover:border-opacity-10 rounded-xl box-shadow hover:bg-white max-w-[369px] mx-auto hover:bg-opacity-10 cursor-pointer'>
                {obj.icon}
